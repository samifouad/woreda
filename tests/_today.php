...
TODO: 'Filter' will need to be adjusted so it doesn't 
interfere or overwhelm the menu button in the top right
perhaps a new colour or different size

TODO: today scroll menu needs javascript intervention to 
make the spacing work for different breakpoints, it cannot
work as is based on static values or CSS

TODO: design tweet layout for different size boxes in the grid
...
<html>
    ...
    html {
      ...
      * {
      ...
      .cat-fade {
        ...
        background-image: linear-gradient(to right, rgba(251,251,251,0.90), rgba(251,251,251,1));
        position: absolute;
        width: 20%;
        margin-top: 25px;
        height: 50px;
      ...
      .cat-fade-left {
        ...
        background-image: linear-gradient(to right, rgba(251,251,251,0.9), rgba(251,251,251,1));
      }
      .filter {
        float: right;
        width: 25%;
  ...
  <body>
    ...
    <div class="footing" style="margin-top: 30px; width: 90%; margin-left: auto; margin-right: auto; padding: 15px;">
      this is the footer
    </div>
  </body>
</html>